    ...
    <div className="space-y-8">
      ...
      >
        <div className="space-y-1">
          <h2 className="text-base font-semibold">Begin your journey</h2>
          <p className="text-xs text-muted-foreground">One small step toward financial clarity</p>
        </div>
        ...
        <form action={action} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input id="name" name="name" placeholder="Ashley" required
          ...
          <Button className="w-full mt-2" type="submit" disabled={pending}>
            {pending ? 'Preparing for launch…' : 'Initialize mission'}
          </Button>
